...
class _AddCourseScreenState extends State<AddCourseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String currentGradeLabel = _gradeMap.entries
        .firstWhere((entry) => entry.value == _selectedGradePoint)
        .key;
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: _gradeMap.keys.map((String key) {
                  return DropdownMenuItem<String>(value: key, child: Text(key, style: const TextStyle(fontWeight: FontWeight.w600)));
                }).toList(),
                onChanged: (val) {
                  if (val != null) {
                    setState(() {
                      _selectedGradePoint = _gradeMap[val]!;
                    });
                  }
                },
              ),
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: Text(
                        _selectedCredit.toStringAsFixed(1),
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        if (_selectedCredit > 1.0) setState(() => _selectedCredit -= 0.5);
                      },
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        if (_selectedCredit < 6.0) setState(() => _selectedCredit += 0.5);
                      },
                    ),
                  ),
                ],
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Add Course', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ),
